...
int threshold = 250; //threshold for IF statement in While loop
...
void loop() {
  ...
  while (remoteState < 20) {
    ...
    if (elapsedMillis < threshold) {
      analogWrite(topMotorDir1, 90);
      analogWrite(bottomMotorDir1, 90);
      //Serial.println("JUMP START");
      //Serial.print("Jump Start Elapsed Millis is ");
      //Serial.println(elapsedMillis);
      //Serial.print("Jump Start Current Millis is ");
      //Serial.println(currentMillis);
      //Serial.println("Jump Start Prior Millis is");
      //Serial.println(priorMillis);
    ...
    feedSpeed = map(feedRate, 0, 1023, 40, 3900);
    ...
    digitalWrite(feedDir, LOW); //High and Low sets direction of feed stepper motor
    ...
    //Serial.print("While Loop Elapsed Millis is ");
    //Serial.println(elapsedMillis);
    //Serial.print("While Loop Current Millis is ");
    //Serial.println(currentMillis);
    //Serial.print("While Loop Prior Millis is ");
    //Serial.println(priorMillis);
  }
